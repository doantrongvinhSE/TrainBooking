...
function Footer() {
  return (
    <footer class="w-full bg-[#0678FF]">
    <div class="mx-auto container px-4 py-5 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            ...
            <a href="/" className="text-white font-extrabold text-2xl">
                Metro<span className="text-black">way</span>
              </a>
            ...
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-white text-whitefont-medium mb-7">Pagedone</h4>
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li><a href="javascript:;"  class=" text-white hover:text-gray-900">Pricing</a></li>
                </ul>
            </div>
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li><a href="javascript:;"  class=" text-white hover:text-gray-900">Responsive Blocks</a></li>
                </ul>
            </div>
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-white font-medium mb-7">Support</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-white hover:text-gray-900">Customer Support</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-white hover:text-gray-900">Terms & Conditions</a></li>
                    <li ><a href="javascript:;"  class=" text-white hover:text-gray-900">Privacy Policy</a></li>
                </ul>
            </div>
            <div class="lg:mx-auto text-left ">
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-800 ">©<a href="https://pagedone.io/">pagedone</a> 2024, All rights reserved.</span>
